...
{
    public class EditGoodsReceivedNoteFreeItemDtoValidator : AbstractValidator<EditGoodsReceivedNoteFreeItemDto>
    {
        public EditGoodsReceivedNoteFreeItemDtoValidator()
        {
