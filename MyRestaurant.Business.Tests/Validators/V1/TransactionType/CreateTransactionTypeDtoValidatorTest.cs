...
{
    public class CreateTransactionTypeDtoValidatorTest : IClassFixture<CreateTransactionTypeDtoValidatorFixture>
    {
        private readonly CreateTransactionTypeDtoValidatorFixture _fixture;

        public CreateTransactionTypeDtoValidatorTest(CreateTransactionTypeDtoValidatorFixture fixture)
        {
            _fixture = fixture;
        }
