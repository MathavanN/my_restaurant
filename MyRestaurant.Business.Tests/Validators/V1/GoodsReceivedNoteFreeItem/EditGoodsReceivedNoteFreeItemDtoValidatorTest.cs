...
{
    public class EditGoodsReceivedNoteFreeItemDtoValidatorTest : IClassFixture<EditGoodsReceivedNoteFreeItemDtoValidatorFixture>
    {
        private readonly EditGoodsReceivedNoteFreeItemDtoValidatorFixture _fixture;

        public EditGoodsReceivedNoteFreeItemDtoValidatorTest(EditGoodsReceivedNoteFreeItemDtoValidatorFixture fixture)
        {
            _fixture = fixture;
        }
