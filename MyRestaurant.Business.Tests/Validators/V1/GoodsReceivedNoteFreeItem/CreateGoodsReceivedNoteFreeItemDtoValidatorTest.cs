...
{
    public class CreateGoodsReceivedNoteFreeItemDtoValidatorTest : IClassFixture<CreateGoodsReceivedNoteFreeItemDtoValidatorFixture>
    {
        private readonly CreateGoodsReceivedNoteFreeItemDtoValidatorFixture _fixture;

        public CreateGoodsReceivedNoteFreeItemDtoValidatorTest(CreateGoodsReceivedNoteFreeItemDtoValidatorFixture fixture)
        {
            _fixture = fixture;
        }
