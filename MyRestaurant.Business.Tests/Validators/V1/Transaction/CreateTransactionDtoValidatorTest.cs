...
{
    public class CreateTransactionDtoValidatorTest : IClassFixture<CreateTransactionDtoValidatorFixture>
    {
        private readonly CreateTransactionDtoValidatorFixture _fixture;

        public CreateTransactionDtoValidatorTest(CreateTransactionDtoValidatorFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public void Should_Not_Have_Error_When_Valid_Dto()
        {
            ...
            _fixture.Model.Date = DateTime.Now.AddDays(-2);
            _fixture.Model.Description = "Interest from Deposit";
            _fixture.Model.Amount = 456.5m;
