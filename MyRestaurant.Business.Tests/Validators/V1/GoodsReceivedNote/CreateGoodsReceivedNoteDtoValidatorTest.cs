...
{
    public class CreateGoodsReceivedNoteDtoValidatorTest : IClassFixture<CreateGoodsReceivedNoteDtoValidatorFixture>
    {
        private readonly CreateGoodsReceivedNoteDtoValidatorFixture _fixture;

        public CreateGoodsReceivedNoteDtoValidatorTest(CreateGoodsReceivedNoteDtoValidatorFixture fixture)
        {
            _fixture = fixture;
        }
