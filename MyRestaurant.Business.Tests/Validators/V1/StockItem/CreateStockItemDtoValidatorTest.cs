...
{
    public class CreateStockItemDtoValidatorTest : IClassFixture<CreateStockItemDtoValidatorFixture>
    {
        private readonly CreateStockItemDtoValidatorFixture _fixture;
        public CreateStockItemDtoValidatorTest(CreateStockItemDtoValidatorFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public void Should_Not_Have_Error_When_Valid_Dto()
        {
            ...
            _fixture.Model.Name = "Rice";
            _fixture.Model.ItemUnit = 5;
            _fixture.Model.UnitOfMeasureId = 1;
            _fixture.Model.Description = "Rice 5kg bag";
