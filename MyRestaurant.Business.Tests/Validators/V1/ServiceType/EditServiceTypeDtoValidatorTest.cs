...
{
    public class EditServiceTypeDtoValidatorTest : IClassFixture<EditServiceTypeDtoValidatorFixture>
    {
        private readonly EditServiceTypeDtoValidatorFixture _fixture;

        public EditServiceTypeDtoValidatorTest(EditServiceTypeDtoValidatorFixture fixture)
        {
            _fixture = fixture;
        }
