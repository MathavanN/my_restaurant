...
{
    public class CreatePaymentTypeDtoValidatorTest : IClassFixture<CreatePaymentTypeDtoValidatorFixture>
    {
        private readonly CreatePaymentTypeDtoValidatorFixture _fixture;

        public CreatePaymentTypeDtoValidatorTest(CreatePaymentTypeDtoValidatorFixture fixture)
        {
            _fixture = fixture;
        }
