...
{
    public class CreatePurchaseOrderItemDtoValidatorTest : IClassFixture<CreatePurchaseOrderItemDtoValidatorFixture>
    {
        private readonly CreatePurchaseOrderItemDtoValidatorFixture _fixture;

        public CreatePurchaseOrderItemDtoValidatorTest(CreatePurchaseOrderItemDtoValidatorFixture fixture)
        {
            _fixture = fixture;
        }
