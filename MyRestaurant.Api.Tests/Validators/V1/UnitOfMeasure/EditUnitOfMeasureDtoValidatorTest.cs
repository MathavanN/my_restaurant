...
{
    public class EditUnitOfMeasureDtoValidatorTest : IClassFixture<EditUnitOfMeasureDtoValidatorFixture>
    {
        private readonly EditUnitOfMeasureDtoValidatorFixture _fixture;
        public EditUnitOfMeasureDtoValidatorTest(EditUnitOfMeasureDtoValidatorFixture fixture)
        {
            _fixture = fixture;
        }
