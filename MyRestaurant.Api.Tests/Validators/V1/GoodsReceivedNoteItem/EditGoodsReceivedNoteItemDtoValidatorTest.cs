...
{
    public class EditGoodsReceivedNoteItemDtoValidatorTest : IClassFixture<EditGoodsReceivedNoteItemDtoValidatorFixture>
    {
        private readonly EditGoodsReceivedNoteItemDtoValidatorFixture _fixture;

        public EditGoodsReceivedNoteItemDtoValidatorTest(EditGoodsReceivedNoteItemDtoValidatorFixture fixture)
        {
            _fixture = fixture;
        }
