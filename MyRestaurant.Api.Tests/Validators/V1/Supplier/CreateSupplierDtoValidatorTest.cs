...
namespace MyRestaurant.Api.Tests.Validators.V1.Supplier
{
    public class CreateSupplierDtoValidatorTest : IClassFixture<CreateSupplierDtoValidatorFixture>
    {
        private readonly CreateSupplierDtoValidatorFixture _fixture;

        public CreateSupplierDtoValidatorTest(CreateSupplierDtoValidatorFixture fixture)
        {
            _fixture = fixture;
        }
