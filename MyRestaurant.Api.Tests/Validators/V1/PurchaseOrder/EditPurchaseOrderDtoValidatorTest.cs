...
{
    public class EditPurchaseOrderDtoValidatorTest : IClassFixture<EditPurchaseOrderDtoValidatorFixture>
    {
        private readonly EditPurchaseOrderDtoValidatorFixture _fixture;

        public EditPurchaseOrderDtoValidatorTest(EditPurchaseOrderDtoValidatorFixture fixture)
        {
            _fixture = fixture;
        }
