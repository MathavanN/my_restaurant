...
namespace MyRestaurant.Api.Tests.Controllers.V1
{
    public class ServiceTypeControllerTest : IClassFixture<ServiceTypeControllerFixture>
    {
        ...
        [Fact]
        public async void GetServiceTypes_ReturnsOkObjectResult()
        {
            //Arrange
        ...
        [Fact]
        public async void GetServiceType_ReturnsOkObjectResult()
        {
            //Arrange
            var id = 1;
            _fixture.MockServiceTypeRepository.Setup(x => x.GetServiceTypeAsync(id))
        ...
        [Fact]
        public async void CreateServiceType_ReturnCreatedAtRouteResult()
        {
            //Arrange
            _fixture.MockServiceTypeRepository.Setup(x => x.CreateServiceTypeAsync(_fixture.ValidCreateServiceTypeDto))
        ...
        [Fact]
        public async void UpdateServiceType_ReturnsOkObjectResult()
        {
            //Arrange
            var id = 1;
            _fixture.MockServiceTypeRepository.Setup(x => x.UpdateServiceTypeAsync(id, _fixture.ValidUpdateServiceTypeDto))
        ...
        [Fact]
        public async void DeleteServiceType_ReturnNoContentResult()
        {
            //Arrange
            var id = 2;
            _fixture.MockServiceTypeRepository.Setup(x => x.DeleteServiceTypeAsync(id));
